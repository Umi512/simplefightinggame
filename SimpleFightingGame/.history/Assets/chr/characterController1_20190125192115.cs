...
public class characterController1 : MonoBehaviour
{
	...
	[SerializeField] private float time_bettween_shot = 1.35f; 
    ...
    private void Update()
    {
        ...
        //if (countdown.guiText.txt == "00:00")
        //{
        //    return;
        //}
    ...
    private void OnCollisionEnter2D(Collision2D col)
    {
        ...
        //print("aaaa");
		if (col.gameObject.tag == "Ground" || col.gameObject.tag == "TransformGround")
        {
            isGround = true;
        }
    }
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        //JumpBlock
        if(col.CompareTag("Player")||col.CompareTag("Player1"))
		{	//Playerの速度に合わせて、ジャンプ力調整
			target = -col.GetComponent<Rigidbody2D>().velocity;
			col.GetComponent<Rigidbody2D>().AddForce (new Vector3(powerX,powerY,0)+target*50);
		}
    }
